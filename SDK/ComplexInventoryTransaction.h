...
public:
	...
	ItemUseInventoryTransaction(int slot, ItemStack const* item, Vector3 const pos, int blockSide = 255, int runtimeBlockId = 0);

private:
	char pad_0x68[0x4];  //0x68
public:
	Vector3i blockPos;    //0x6C
