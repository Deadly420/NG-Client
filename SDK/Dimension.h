...
public:
	...
	virtual void onBlockChanged(BlockSource &, Vector3i const &, unsigned int, Block const &, Block const &, int, class ActorBlockSyncMessage const *, class BlockChangedEventTarget);
	...
	virtual void addParticleEffect(HashedString const &, Vector3 const &, class MolangVariableMap const &);
	virtual void addParticleEffect2(HashedString const &, Entity const &, HashedString const &, Vector3 const &, MolangVariableMap const &);
	...
	virtual void addBreakingItemParticleEffect(Vector3 const &, ParticleType, struct TextureUVCoordinateSet const &, bool);
	virtual void playMusic(std::string const &, Vector3 const &, float, float);
	...
	virtual void levelSoundEvent(std::string const &, Vector3 const &, float, float);
