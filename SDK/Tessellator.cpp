...
mce::Mesh* BlockTessellator::getMeshForBlockInWorld(Tessellator *t, Block *block, Vector3i &pos) {
	using BT_getMeshForBlockInWorld_t = mce::Mesh* (*)(BlockTessellator *, Tessellator *, Block *, Vector3i &, int, __int64);
